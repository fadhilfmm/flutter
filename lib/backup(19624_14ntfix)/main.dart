...
class MyHomePageState extends State<MyHomePage> {
  ...
  String selectedEventType = 'All'; // Default value for event type filter
  ...
  void filterData() {
    ...
    setState(() {
      filteredDataList = dataList.where((item) {
        ...
        final eventType = item['event_type']?.toLowerCase() ?? '';

        bool matchesQuery = name.contains(query) ||
            timeDetected.contains(query) ||
            additionalInfo.contains(query);
        bool matchesEventType = selectedEventType == 'All' ||
            eventType == selectedEventType.toLowerCase();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          const CircleAvatar(
            backgroundImage: AssetImage('assets/polman_profile.png'),
          ),
              ...
              builder: (BuildContext context,
                ...
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  if (data is Map<dynamic, dynamic>) {
                    ...
                    // Update the filtered data only once the dataList is updated
